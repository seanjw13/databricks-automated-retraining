...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``automated_retraining/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in automated-retraining/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in automated-retraining/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-automated-retraining-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.sewi.automated-retraining-model", "Full (Three-Level) Model Name")
