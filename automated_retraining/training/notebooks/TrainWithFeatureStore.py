...
# ``automated_retraining/assets/model-workflow-asset.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-automated-retraining-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.sewi.automated-retraining-model", label="Full (Three-Level) Model Name"
)
...
dbutils.widgets.text(
    ...
    "dev.sewi.trip_dropoff_features",
