...
[ML Config](../automated_retraining/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore automated_retraining/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [automated-retraining/databricks.yml](../automated_retraining/databricks.yml)
and [automated-retraining/assets/ml-artifacts-asset.yml](../automated_retraining/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [automated-retraining/assets/README.md](../automated_retraining/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../automated_retraining/assets/README.md)  to propose, test, and deploy
