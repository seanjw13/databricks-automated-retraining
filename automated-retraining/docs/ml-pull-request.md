...
Opening a pull request will trigger a[workflow](../.github/workflows/automated-retraining-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-automated-retraining-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-automated-retraining-model)
